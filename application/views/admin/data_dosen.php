                        ...
                        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                            <thead class="align-bottom">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">NIP</th>
                                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <?php foreach ($dosen as $d) : ?>
                                    <tr class="hover:bg-blue-100 transition duration-200">
                                        ...
                                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span class="text-xs font-semibold leading-tight text-slate-400"><?= htmlspecialchars($d->nama); ?></span>
                                        </td>
                                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span class="text-xs font-semibold leading-tight text-slate-400"><?= htmlspecialchars($d->email); ?></span>
                                        </td>
                                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <span class="text-xs font-semibold leading-tight text-slate-400"><?= htmlspecialchars($d->nip); ?></span>
                                        </td>
                                        <td class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
    <div class="flex justify-center space-x-2">
        <a href="<?= site_url('admin/edit_dosen/' . $d->id); ?>" class="px-2 py-1 text-xs font-semibold text-blue-600 hover:bg-blue-100 rounded">Edit</a>
        <a href="<?= site_url('admin/delete_dosen/' . $d->id); ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="px-2 py-1 text-xs font-semibold text-red-600 hover:bg-red-100 rounded">Delete</a>
    </div>
</td>
