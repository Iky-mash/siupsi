  ...
  <div class="max-w-3xl mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-soft-xl">
    ...
    <p class="mt-4 text-xs text-gray-600 leading-relaxed">
      ...
      <ul class="list-disc list-inside pl-1 mt-1">
        ...
        <li>Untuk kolom ID Dosen (Pembimbing dan Penguji), jika mahasiswa belum memiliki dosen yang ditugaskan, biarkan sel tersebut **benar-benar kosong**. Jangan diisi dengan angka 0, tanda strip (-), atau teks "kosong".</li>
