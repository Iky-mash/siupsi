...
<div class="min-h-screen flex flex-col px-6 py-6 mx-auto">
    ...
    <div id="form-jadwal" class="hidden bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <form action="<?= base_url('kabag/update_jadwal') ?>" method="POST">
            <div class="mb-4">
...
<div class="mt-10">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="<?= site_url('ruangan/tambah_kabag'); ?>" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
            Tambah Ruangan
        </a>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 border">
                                <a href="<?= site_url('ruangan/edit_kabag/'.$r->id); ?>" class="text-blue-600 hover:underline">Edit</a> |
                                <a href="<?= site_url('ruangan/hapus_kabag/'.$r->id); ?>" onclick="return confirm('Hapus data?')" class="text-red-600 hover:underline">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
