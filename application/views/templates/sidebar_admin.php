...
<li class="mt-0.5 w-full">
    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="<?= base_url('admin'); ?>">
  ...
  <li class="mt-0.5 w-full">
    <a
        ...
        <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Pekan Seminar</span>
    </a>
</li>
<li class="mt-0.5 w-full">
    <a
        class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%]"
        href="<?= base_url('admin/data_mahasiswa') ?>">
        <div
            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg
                width="12px"
        ...
        <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Data Mahasiswa</span>
    </a>
</li>
...
<li class="mt-0.5 w-full">
    <a
        class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%]"
        href="<?= base_url('admin/data_dosen'); ?>">
        <div
            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg
                width="12px"
        ...
        <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Data Dosen</span>
    </a>
</li>
...
<li class="mt-0.5 w-full">
    <a
        class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%]"
        href="<?= base_url('admin/pengajuan_ujian'); ?>">
        <div
            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg
                width="12px"
        ...
        <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Pengajuan Ujian Skripsi</span>
    </a>
</li>
...
<li class="mt-0.5 w-full">
    <a
        ...
        <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Agenda Dosen</span>
    </a>
</li>
<!-- <li class="mt-0.5 w-full">
    <a
        class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%]"
        href="<?= base_url('admin/mahasiswa_disetujui') ?>">
        <div
            class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            <svg
                width="12px"
        ...
        <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Ajukan Ujian Skripsi</span>
    </a>
</li> -->
...
<li class="mt-0.5 w-full">
    <a
        ...
        <span
            class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Laporan</span>
    </a>
</li>
<li class="mt-0.5 w-full">
    <a
        class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%]"
        href="<?= base_url('Admin/jadwalAdmin') ?>">
        <div
