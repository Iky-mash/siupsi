<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const menuLinks = document.querySelectorAll('#menu a'); // Pilih semua link dalam menu
    
        // Loop melalui setiap menu link
        menuLinks.forEach(link => {
            // Hapus class 'active' terlebih dahulu (antisipasi reload)
            link.classList.remove('active');
    
            // Periksa apakah `href` link termasuk nama file saat ini
            const linkPath = link.getAttribute('href').split('/').pop(); // Ambil nama file dari link
            if (linkPath === currentPath) {
                link.classList.add('active'); // Tambahkan class "active" jika cocok
            }
        });
    });            
</script>
<style>
    /* Gaya default untuk link */
    #menu a {
        color: #333; /* Warna teks default */
        text-decoration: none; /* Hapus underline */
        transition: background-color 0.3s, color 0.3s; /* Animasi untuk efek */
    }

    /* Gaya menu aktif */
    #menu a.active {
        background-color: #007bff; /* Warna latar untuk menu aktif */
        color: #fff; /* Warna teks menu aktif */
        border-radius: 8px; /* Membuat sudut membulat */
    }

    /* Gaya hover untuk menu aktif */
    #menu a.active:hover {
        background-color: #0056b3; /* Warna latar saat hover */
        color: #e6e6e6; /* Warna teks saat hover */
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* Tambahkan bayangan */
    }

    /* Hover untuk menu lainnya (non-aktif) */
   ...
   <aside
                ...
                <div
                    class="items-center block w-auto max-h-screen overflow-auto h-full grow basis-full">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="<?= base_url('dosen'); ?>">
            ...
            <li class="mt-0.5 w-full">
                <a
                    class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%] active:hover:bg-white active:hover:rounded-[20%]"
                    href="<?php echo base_url('dosen/mahasiswa_bimbingan'); ?>">
                    <div
            ...
            <li class="mt-0.5 w-full">
                <a
                    ...
                    href="<?= base_url('dosen/jadwal_ujian') ?>">
                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg
                            width="12px"
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Jadwal Ujian Skripsi</span>
                </a>
            </li>
        <li class="mt-0.5 w-full">
                <a
                    class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%]"
                    href="<?= base_url('dosen/riwayat_ujian/' ) ?>">
                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg
                            width="12px"
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Riwayat Ujian</span>
                </a>
            </li> 
            ...
            <li class="mt-0.5 w-full">
                <a
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Agenda Saya</span>
                </a>
            </li>
            ...
            <li class="mt-0.5 w-full">
                <a
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Logout</span>
                </a>
            </li>
            <!-- <li class="mt-0.5 w-full">
                <a
                    class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors active:hover:bg-white active:hover:rounded-[20%]"
                    href="<?= base_url() ?>pages/billing.html">
                    <div
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Pengaturan</span>
                </a>
            </li> -->
            </ul>
                </div>
