...
<li class="mt-0.5 w-full">
                <a
                    class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="<?= base_url('kabag/reschedule') ?>">
                    <div
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Riwayat Reschedule</span>
                </a>
            </li> 
         <li class="mt-0.5 w-full">
                <a
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Kelola Ruangan</span>
                </a>
            </li> 
