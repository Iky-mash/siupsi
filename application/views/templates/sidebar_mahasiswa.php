        ...
        <ul id="menu" class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a
                    ...
                    href="<?= base_url('mahasiswa/jadwal_ujian');?>">
                    <div
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Jadwal Ujian Saya</span>
                </a>
            </li>
            ...
            <!--     <li class="mt-0.5 w-full">
                <a
                    ...
                    <span
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Riwayat Pengajuan</span>
                </a>
            </li> -->
         ...
         <li class="mt-0.5 w-full">
                <a
                    class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="<?= base_url('mahasiswa/riwayat_pengajuan') ?>">
                    <div
                        class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg
                            width="12px"
